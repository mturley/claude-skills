...
1. Set up the Atlassian MCP server. We use the official Atlassian Cloud MCP with Streamable HTTP transport pointed at `redhat.atlassian.net`. See `../.context/jira-mcp.md` for configuration details.
